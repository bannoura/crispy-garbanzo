...
FirstName = UCase(objuser.givenName)
LastName = UCase(objuser.sn)
EMail = objuser.mail
...
'====================
Dim objShell, RegKey, RegKey07, RegKey10, RegKey13, RegKey16, RegKeyParm
...
objShell.RegWrite RegKey16 , "Signatures"
...
objfile.write "<body link=" & aQuote & "#002D72" & aQuote & ">" & vbCrLf
...
objfile.write "			<TD style=" & aQuote & "VERTICAL-ALIGN: top" & aQuote & "<A href=" & aQuote & "http://www.truckcenter.com" & aQuote & "><IMG title=" & aQuote & "TruckCenter" & aQuote & " border=0 name=" & aQuote & "Liquidity Services Inc." & aQuote & " alt=" & aQuote & "Liquidity Services Inc." & aQuote & " src=" & aQuote & "http://media.liquidityservices.com/TruckCenter/TRUCKCENTERLOGO-RGB.jpg" & aQuote & " width=160 height=75></A> </TD>"& vbCrLf
objfile.write "			<TD style=" & aQuote & "HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom" & aQuote & " bgColor=#ffffff>__</TD>"& vbCrLf
objfile.write "			<TD style=" & aQuote & "WIDTH: 1px; HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom" & aQuote & " bgColor=#002D72></TD>"& vbCrLf
objfile.write "			<TD style=" & aQuote & "HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom" & aQuote & " bgColor=#ffffff>__</TD>"& vbCrLf
...
objfile.write "                       <TBODY>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & "><b>" & FirstName & " " & LastName & "</b></TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & "><b>" & Title & "</b></TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
...
If PhoneNumber <> "" Then
	objfile.write "                           <TR>"& vbCrLf
	objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & ">" & PhoneNumber & " (Office)</SPAN></TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End if

If MobileNumber <> "" Then
	objfile.write "							<TR>"& vbCrLf
	objfile.write "								<TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & ">" & MobileNumber & " (Mobile)</SPAN> </TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End If

IF FaxNumber <> "" Then
	objfile.write "							<TR>"& vbCrLf
	objfile.write "								<TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & ">" & FaxNumber & " (Fax)</SPAN> </TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End IF

If SkypeName <> "" then
	objfile.write "							<TR>"& vbCrLf
	objfile.write "								<TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & ">" & SkypeName & " (Skype)</SPAN></TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End if

objfile.write "							<TR>"& vbCrLf
objfile.write "								<TD style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & " noWrap><SPAN id=email>" & EMail & "</SPAN></TD>"& vbCrLf
objfile.write "							</TR>"& vbCrLf
...
'objfile.write "                           <TR>"& vbCrLf
'objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & ">Liquidity Services</TD>"& vbCrLf
'objfile.write "                           </TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & ">" & StreetAddress & "</TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & ">" & Town & ", " & State & " " & ZipCode & " " & Country & "</TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf



objfile.write "							<TR>"& vbCrLf
objfile.write "								<TD style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 12px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72" & aQuote & " href=" & aQuote & "http://www.truckcenter.com" & aQuote &">www.truckcenter.com</A></TD>"& vbCrLf
objfile.write "						</TR>"& vbCrLf
'objfile.write "                           <TR>"& vbCrLf
