...
'====================
Dim objShell, RegKey, RegKey07, RegKey10, RegKey13, RegKeyParm
...
objfile.write "			<TD style=" & aQuote & "VERTICAL-ALIGN: top" & aQuote & "<A href=" & aQuote & "http://www.IronDirect.com" & aQuote & "><IMG title=" & aQuote & "IronDirect" & aQuote & " border=0 name=" & aQuote & "IronDirect" & aQuote & " alt=" & aQuote & "IronDirect" & aQuote & " src=" & aQuote & "http://media.liquidityservices.com/IronDirect/IronDirect_Logo_wTag_forWhtBkgd-01.png" & aQuote & " width=190 height=50></A> </TD>"& vbCrLf
objfile.write "			<TD style=" & aQuote & "HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom" & aQuote & " bgColor=#ffffff>__</TD>"& vbCrLf
objfile.write "			<TD style=" & aQuote & "WIDTH: 1px; HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom" & aQuote & " bgColor=#000000></TD>"& vbCrLf
objfile.write "			<TD style=" & aQuote & "HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom" & aQuote & " bgColor=#ffffff>__</TD>"& vbCrLf



objfile.write "               <TD rowspan="& aQuote & "3" & aQuote &">"& vbCrLf
objfile.write "                  <TABLE id=emailsignatureDetails border=0 cellSpacing=0 cellPadding=1>"& vbCrLf
objfile.write "                       <TBODY>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & "><b>" & FirstName & " " & LastName & "</b></TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & "><b>" & Title & "</b></TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
...
If PhoneNumber <> "" Then
	objfile.write "                           <TR>"& vbCrLf
	objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & ">" & PhoneNumber & " (Office)</SPAN></TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End if

If MobileNumber <> "" Then
	objfile.write "							<TR>"& vbCrLf
	objfile.write "								<TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & ">" & MobileNumber & " (Mobile)</SPAN> </TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End If

IF FaxNumber <> "" Then
	objfile.write "							<TR>"& vbCrLf
	objfile.write "								<TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000 " & aQuote & ">" & FaxNumber & " (Fax)</SPAN> </TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End IF

If SkypeName <> "" then
	objfile.write "							<TR>"& vbCrLf
	objfile.write "								<TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & ">" & SkypeName & " (Skype)</SPAN></TD>"& vbCrLf
	objfile.write "							</TR>"& vbCrLf
End if

objfile.write "							<TR>"& vbCrLf
objfile.write "								<TD style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & " noWrap><SPAN id=email>" & EMail & "</SPAN></TD>"& vbCrLf
objfile.write "							</TR>"& vbCrLf
...
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & ">IronDirect</TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & ">" & StreetAddress & "</TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & ">" & Town & ", " & State & " " & ZipCode & " " & Country & "</TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
...
objfile.write "							<TR>"& vbCrLf
objfile.write "								<TD style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #000000" & aQuote & " href=" & aQuote & "http://www.IronDirect.com" & aQuote &">www.IronDirect.com</A></TD>"& vbCrLf
objfile.write "						</TR>"& vbCrLf
'objfile.write "                           <TR>"& vbCrLf
'objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 5px;FONT-FAMILY: Arial, Helvetica; COLOR: #FFFFFF" & aQuote & ">Applied By GPO " & FormatDateTime(Now) & "</TD>"& vbCrLf
'objfile.write "                           </TR>"& vbCrLf
objfile.write "					</TBODY>"& vbCrLf
...
objfile.write "			<TR>" & vbCrLf
objfile.write "				<td style=" & aQuote & "Vertical-align: bottom" & aQuote & "; align=" & aQuote & "right" & aQuote & ">"& vbCrLf
objfile.write "					<TABLE>"& vbCrLf
objfile.write "						<TBODY>"& vbCrLf
objfile.write "							<TR align=" & aQuote & "right"& aQuote & ">" & vbCrLf
objfile.write "								<TD style=" & aQuote & "VERTICAL-ALIGN: bottom" & aQuote & "<A href=" & aQuote & "http://fast.wistia.net/embed/iframe/meg5jhs5jw?videoFoam=true" & aQuote & "><IMG style=" & aQuote & "float: right;" & aQuote & " title=" & aQuote & "About IronDirect" & aQuote & " border=0 name=" & aQuote & "About IronDirect" & aQuote & " alt=" & aQuote & "About IronDirect" & aQuote & " src=" & aQuote & "http://media.liquidityservices.com/IronDirect/About_Us.jpg" & aQuote & " width=157 height=21></A> </TD>"& vbCrLf
objfile.write "							</TR>"& vbCrLf

objfile.write "							<TR align=" & aQuote & "right"& aQuote & ">" & vbCrLf
objfile.write "								<TD style=" & aQuote & "VERTICAL-ALIGN: bottom" & aQuote & "<A href=" & aQuote & "http://players.brightcove.net/63193328001/default_default/index.html?videoId=4897877820001" & aQuote & "><IMG  style=" & aQuote & "float: right;" & aQuote & " title=" & aQuote & "About IronDirect" & aQuote & " border=0 name=" & aQuote & "About IronDirect" & aQuote & " alt=" & aQuote & "About IronDirect" & aQuote & " src=" & aQuote & "http://media.liquidityservices.com/IronDirect/See_us_in_action.jpg" & aQuote & " width=157 height=21></A> </TD>"& vbCrLf
objfile.write "							</TR>"& vbCrLf
objfile.write "						</TBODY>"& vbCrLf
objfile.write "					</TABLE>"& vbCrLf
objfile.write "				</td" & vbCrLf
...
If Not IsOutlookRunning Then
	...
	strKeyPath2016 = "Software\Microsoft\Office\16.0\Outlook\Profiles\" '2016 Profile path
	...
	If IsNull(strProfile) Then
		...
		strVersionUntrim = ObjOutlook2013.Version
		strVersionTrim = Left(strVersionUntrim,2)
	...
	strKeyPath2016 = strKeyPath2016 & strProfile & "\9375CFF0413111d3B88A00104B2A6676" '2016 profile path
	...
	objreg.EnumKey HKEY_CURRENT_USER, strKeyPath2016, arrProfileKeys2016
	...
	If Not IsNull(arrProfileKeys2013) And strVersionTrim = "15" Then
	...
	End If
		...
		'Set keys for Outlook 2016
	If Not IsNull(arrProfileKeys2016) And strVersionTrim = "16" Then
		For Each subkey2016 In arrProfileKeys2016
			strsubkeypath2016 = strKeyPath2016 & "\" & subkey2016
			objreg.SetBinaryValue HKEY_CURRENT_USER, strsubkeypath2016, "New Signature", myArray
			objreg.SetBinaryValue HKEY_CURRENT_USER, strsubkeypath2016, "Reply-Forward Signature", myArray
		Next
	End If
Else
