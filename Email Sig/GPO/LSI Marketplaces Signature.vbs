...
Marketplace = objuser.extensionAttribute2
...
objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86" & aQuote & ">" & Marketplace & "</TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf

objfile.write "                           <TR>"& vbCrLf
objfile.write "                               <TD style=" & aQuote & "TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86" & aQuote & ">A Liquidity Services Marketplace</TD>"& vbCrLf
objfile.write "                           </TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
