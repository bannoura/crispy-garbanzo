...
objfile.write "							<TR>"& vbCrLf
objfile.write "								<TD style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86" & aQuote & " <a href=" & aQuote & "http://www.liquidityservices.com" & aQuote &">www.liquidityservices.com</A></TD>"& vbCrLf
objfile.write "						</TR>"& vbCrLf
objfile.write "                           <TR>"& vbCrLf
