...
objfile.write "</TABLE> "& vbCrLf
' IT Support footer
objfile.write "<SPAN style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 10px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86" & aQuote & ">Need Immediate Assistance?</SPAN>"& vbCrLf
objfile.write "<SPAN style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 10px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86" & aQuote & ">Call the Helpdesk at (877)287-2587 or</SPAN>"& vbCrLf
objfile.write "<SPAN style=" & aQuote & "TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 10px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86" & aQuote & ">Email us at <U><A href=" & aQuote & "mailto:ITSupport@liquidityservicesinc.com" & aQuote & ">ITSupport@liquidityservicesinc.com</A></U></SPAN>"& vbCrLf
