...
$EmailSigGroup = Get-MsolGroup -all | where-object { $_.DisplayName -eq "LSI Signature Injection - TruckCenter Template"}
...
<TBODY>
           <TR>
			<TD style=`"VERTICAL-ALIGN: top`"<A href=`"http://www.truckcenter.com`"><IMG title=`"TruckCenter`" border=0 name=`"TruckCenter`" alt=`"TruckCenter`" src=`"http://media.liquidityservices.com/TruckCenter/TRUCKCENTERLOGO-RGB.jpg`" width=160 height=75></A> </TD>
			<TD style=`"HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom`" bgColor=#ffffff>__</TD>
			<TD style=`"WIDTH: 1px; HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom`" bgColor=#002D72></TD>
			<TD style=`"HEIGHT: auto; COLOR: white; VERTICAL-ALIGN: bottom`" bgColor=#ffffff>__</TD>
               <TD>
                  <TABLE id=emailsignatureDetails border=0 cellSpacing=0 cellPadding=1>
                       <TBODY>
                           <TR>
                               <TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`"><b>" + $user.DisplayName + "</b></TD>
                           </TR>
                           <TR>
                               <TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`"><b>" + $user.Title + "</b></TD>
                           </TR>
                           <TR>
                           ...
                           if(($User.Phone).tostring().length -ne 0){ $EmailHtml+=
                            "<TR>
                               <TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`">" + $user.Phone + " (Office)</SPAN></TD>
							</TR>"}
                            if(($User.MobilePhone).tostring().length -ne 0){ $EmailHtml+=
							"<TR>
								<TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`">" + $user.MobilePhone + " (Mobile)</SPAN> </TD>
							</TR>"}
                            if(($User.fax).tostring().length -ne 0){ $EmailHtml+=
							"<TR>
								<TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`">" + $user.fax + " (Fax)</SPAN> </TD>
							</TR>"}
                            if(($UserMailbox.CustomAttribute1).tostring().length -ne 0){ $EmailHtml+=
							"<TR>
								<TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`">" + $UserMailbox.CustomAttribute1 + " (Skype)</SPAN> </TD>
							</TR>"}
							$EmailHtml+= "<TR>
								<TD style=`"TEXT-DECORATION: none; TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`" noWrap><SPAN id=email>" + $user.WindowsEmailAddress + "</SPAN></TD>
							</TR>
                           <TR>
                               <TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 10px;FONT-FAMILY: Arial, Helvetica; COLOR: #FFFFFF`">__</TD>
                           </TR>
                           <TR>
                               <TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`">" + $user.StreetAddress + "</TD>
                           </TR>
                           <TR>
                               <TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`">" + $user.City + ", " + $user.StateOrProvince + " " + $user.PostalCode + " " + $user.CountryOrRegion + "</TD>
                           </TR>
							<TR>
								<TD style=`"TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #002D72`" href=`"http://www.truckcenter.com`">www.TruckCenter.com</A></TD>
						</TR>
					</TBODY>
				</TABLE>
		</TR>
