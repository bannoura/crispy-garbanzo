...
$EmailSigGroup = Get-MsolGroup -all | where-object { $_.DisplayName -eq "LSI Signature Injection - Transporation Template"}
               ...
               <TD>
                  <TABLE id=emailsignatureDetails border=0 cellSpacing=0 cellPadding=1>
                       <TBODY>
                           ...
                           <TR>
                               <TD style=`"TEXT-ALIGN:  Left; FONT-SIZE: 13px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86`">Transportation Group</TD>
                           </TR>
                           <TR>
