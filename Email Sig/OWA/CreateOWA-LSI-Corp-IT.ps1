...
$EmailSigGroup = Get-MsolGroup -all | where-object { $_.DisplayName -eq "LSI Signature Injection - Corp Template with IT Support Footer"}
$EmailSigGroupUK = Get-MsolGroup -all | where-object { $_.DisplayName -eq "LSI Signature Injection - Corp Template with IT Footer UK"}
...
<SPAN style=`"TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 10px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86`">Need Immediate Assistance?</SPAN>
<SPAN style=`"TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 10px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86`">Call the Helpdesk at (877)287-2587 or</SPAN>
<SPAN style=`"TEXT-DECORATION: none; TEXT-ALIGN:  Left;FONT-SIZE: 10px;FONT-FAMILY: Arial, Helvetica; COLOR: #124C86`">Email us at <U><A href=`"mailto:ITSupport@liquidityservicesinc.com`">ITSupport@liquidityservicesinc.com</A></U></SPAN>"
